...
static void setup(void) {
    ...
    test_fs = filesystem_littlefs_create(500, 16);
...
static void cleanup(void) {
    ...
    filesystem_littlefs_free(test_fs);
...
void test_blockdevice_flash_filesystem_littlefs(void) {

    printf("Flash-littlefs filesystem..............");
